...
checkPushButton(uint32_t time)
{
    ...
    case 2:
        ...
        uprintf("%s\n\r", "This is SW2 that is pushed");
        colorChoice = (colorChoice + 2) % LED_COLOR_NUM;
        //Edits: We can see that red comes every two jump
        //red green blue red green blue red green blue
        //Now the order is changed to this: SW2 and SW1 will bring the LED color back and forth if pressed
...
int main(void)
{
    ...
    // Pring out a message
    // See uprintf() in launchpad.h
    uprintf("%s\n\r", "Welcome to ECE 266 Ahmadshah Hazrati!");
